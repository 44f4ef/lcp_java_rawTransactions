...
public class TransactionTest{
    ...
    @Test
    public static void signatureTest() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, UnsupportedEncodingException, SignatureException {
